...
_redraw = 'pos size min max startAngle endAngle tick subtick cadranColor displayFirst displayLast'.split()
...
class SpeedMeter(Widget):
    ...
    def _draw(self, *args):
        ...
        with self.canvas.before:
            ...
            centerx = x + width / 2
            centery = y + height / 2
            theta0 = theta0_ = float(self.startAngle)
            theta1 = theta1_ = float(self.endAngle)
